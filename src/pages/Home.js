      ...
      <div style={{ display: "flex", gap: "20px", fontSize: "1.2rem", flexWrap: "wrap" }} className='wrapper-about'>
        <div className='about-page' >
          <ul>
            ...
            <li><p style={{ marginTop: "20px" }}>The Hostels and other Students Activity facilities  are spread over two campuses, one at WALMI campus and the other in its new Permanant campus at Chikkamalligawad.</p></li>
            ...
            <div className='address'>
              ...
              <div style={{ display: "flex", gap: "10px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }} className='location-sw'>
                  <p >Students Welfare Division -IIT Dharwad</p>

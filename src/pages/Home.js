      ...
      <div style={{ display: "flex", gap: "20px", fontSize: "1.2rem", flexWrap: "wrap" }} className='wrapper-about'>
        <div className='about-page' >
          <ul>
            ...
            <li><p style={{ marginTop: "20px" }}>The Hostels and other Students Activity facilities  are spread over two campuses, one at WALMI campus and the other at Permanant campus at Chikkamalligawad.</p></li>
